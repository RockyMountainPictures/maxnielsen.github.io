...
$to = "m.nielsen@shaw.ca";														// To Address
$from = "m.nielsen@shaw.ca";													// From Address
$fromName = "maxnielsen.ca";											// From Name
...
$template = "Hi,<br><br>You have received a new message from your website.<br><br>{formdata}<br><br>Date: {date}<br>Remote IP: {ip}<br><br>---<br>- Mailform";											// Mail Template
...
$rcp = ("3" == "3" ? true : false);						// Use reCAPTCHA (set to "3" if enabled, "0" if disabled)
$rcpScore = "0.5";									// reCAPTCHA Score
$rcpSecret = "6LdtrM0ZAAAAAMvLyEGlZRfR0a1m7-8SmbYNIftZ";								// reCAPTCHA Secret Key
